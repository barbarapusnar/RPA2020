#pragma checksum "E:\RPA2020\KlicWebAPI-ja\KlicWebAPI-ja\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "DCC510D2459DC342C15AA8FB40763163"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace KlicWebAPI_ja
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj3_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::KlicWebAPI_ja.Slika dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::KlicWebAPI_ja.Slika) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::KlicWebAPI_ja.Slika)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::KlicWebAPI_ja.Slika obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::KlicWebAPI_ja.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::KlicWebAPI_ja.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::KlicWebAPI_ja.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_vsiPsi(global::System.Collections.ObjectModel.ObservableCollection<global::KlicWebAPI_ja.Slika> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
